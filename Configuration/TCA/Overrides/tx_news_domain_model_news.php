...
if (\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::isLoaded('news')) {
    ...
    \TYPO3\CMS\Core\Utility\ArrayUtility::mergeRecursiveWithOverrule(
        ...
        [
            'ecom_event_contact'        => [
                'showitem'       => 'ecom_event_name,--linebreak--,ecom_event_host,ecom_event_website,--linebreak--,ecom_event_consultants',
                'canNotCollapse' => 1
            ],
            'ecom_event_dates'          => ['showitem' => 'ecom_event_date,ecom_event_end', 'canNotCollapse' => 1],
            'ecom_event_daily_openings' => ['showitem'       => 'ecom_event_open_from,ecom_event_open_till',
                                            'canNotCollapse' => 1
            ],
            'ecom_event_location'       => ['showitem'       => 'ecom_event_booth,--linebreak--,ecom_event_country,ecom_event_state,--linebreak--,ecom_event_zip,ecom_event_city,--linebreak--,ecom_event_address,--linebreak--, ecom_event_maps_location',
                                            'canNotCollapse' => 1
            ],
            'ecom_event_topic'          => ['showitem'       => 'ecom_event_industries,--linebreak--,ecom_event_industries_custom',
                                            'canNotCollapse' => 1
            ]
        ]
    );
