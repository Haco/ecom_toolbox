...
$columns = [
	'ecom_toolbox_country' => [
		'exclude' => 1,
		'label' => 'LLL:EXT:ecom_toolbox/Resources/Private/Language/locallang_db.xlf:fe_users.ecom_toolbox_country',
		'config' => [
			'type' => 'select',
			'items' => [
				['']
	...
	'ecom_toolbox_state' => [
		...
		'exclude' => 1,
		'label' => 'LLL:EXT:ecom_toolbox/Resources/Private/Language/locallang_db.xlf:fe_users.ecom_toolbox_state',
		'config' => [
			'type' => 'select',
			'items' => [
				[ '', 0 ]
	...
	'privacy_policy' => [
		'exclude' => 1,
		'label' => 'LLL:EXT:ecom_toolbox/Resources/Private/Language/locallang_db.xlf:fe_users.privacy_policy',
		'config' => [
			'type' => 'check',
			'default' => 1
		]
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes( 'fe_users', 'ecom_toolbox_country, ecom_toolbox_state, privacy_policy', '', 'replace:country' );