...
/**
 * Class DetectMobileViewHelper
 * @package TYPO3\CMS\Fluid\ViewHelpers\Ecom
 *
 * Conditional detection of all mobile devices
 */

class DetectMobileViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractConditionViewHelper {
	...
	public function render() {
		...
		if ($isMobile) {
			$renderContent = $this->renderThenChild();
		} else {
			$renderContent = $this->renderElseChild();
		}
