...
class AjaxDispatcher
{
     ...
     * @var array
     */
    protected $allowedRequestArguments = [
        'vendorName',
        'extensionName',
        'pluginName',
        'controllerName',
    ...
    protected function setRequestArgumentsFromGPvar()
    {
        foreach ($this->allowedRequestArguments as $argument) {
            if (CoreUtility\GeneralUtility::_GP($argument)) {
                $this->requestArguments[ $argument ] = CoreUtility\GeneralUtility::_GP($argument);
            }
        }
    }
    ...
    {
        foreach ($this->allowedRequestArguments as $argument) {
            if ($requestArguments[ $argument ]) {
                $this->requestArguments[ $argument ] = $requestArguments[ $argument ];
            }
        }
    }
